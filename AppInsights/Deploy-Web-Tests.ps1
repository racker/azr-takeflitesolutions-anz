<#
  .SYNOPSIS
  Creates a resourcegroup, webtest and applies tags for AppInsight monitoring
  
  .NOTES
  Version:        1.0
  Author:         Aaron Saikovski
  Creation Date:  19th January 2017
...
#region - AUE, JPE, WEU
[string]$targetregion = "WEU"

#Set environment
[string]$activeEnvironment = "PROD" #Allowed - PREPROD, PROD

#Resourcegroup where the webapps reside
[string]$resourcegroup ="DPE-OLO-" + $activeEnvironment + "-" + $targetregion
#[string]$resourcegroup ="DPE-OLO-" + $activeEnvironment + "-GLOBAL"

#new RSG Prefix
[string]$rsgname = "DPE-RAXMON-OLO-" + $activeEnvironment + "-" 
#[string]$rsgname = "DPE-RAXMON-OLO-" + $activeEnvironment + "-GLOBAL" + "-" 
